    ...
    <body>
        <div id="parentDiv"> 
            ...
            <div id="childDiv1" class="font">
                <!--child 1-->
                Doctor Login
                <img src="Images/Doctor logo.jpg">
            </div>
            ...
            <div id="childDiv2" >
                ...
                <form id="subDiv2" >
                <!--child 3-->
                    <p class="font size textcolor1">Don't have an account? <a class="font size textcolor2" href="SignupDoctor.php">Sign Up</a></p>
        ...
        <?php 
                ...
                if(isset($_POST['btnsignin'])){
                    ...
                    $pw = $_POST['txtpassword'];
                        ...
                        $sql = "SELECT * FROM tbldoctor WHERE username='$un' AND password='$pw'";
